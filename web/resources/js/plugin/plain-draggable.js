var PlainDraggable =
    ...
    /******/ ({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__["default"] = (AnimEvent);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (CSSPrefix);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (mClassList);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */
            var anim_event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! anim-event */ "./node_modules/anim-event/anim-event.esm.js");
...
// Support options for addEventListener
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (PointerEvent);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */
            var pointer_event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pointer-event */ "./node_modules/pointer-event/pointer-event.esm.js");
            /* harmony import */
            var cssprefix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! cssprefix */ "./node_modules/cssprefix/cssprefix.esm.js");
            /* harmony import */
            var anim_event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! anim-event */ "./node_modules/anim-event/anim-event.esm.js");
            /* harmony import */
            var m_class_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! m-class-list */ "./node_modules/m-class-list/m-class-list.esm.js");
...
// PPBBox -> BBox
            ...
            function moveTranslate(props, position) {
                ...
                if (position.left !== elementBBox.left || position.top !== elementBBox.top) {
                    ...
                    props.elementStyle[cssPropTransform] = "translate(".concat(position.left + offset.left, "px, ").concat(position.top + offset.top, "px)").concat(` scale(${props.options.scale})`);
                    return true;
                }
                return false;
            } // [LEFTTOP]
...
// [SVG]
            ...
            function initTranslate(props) {
                ...
                elementStyle[cssPropTransform] = `translate(0, 0) scale(${props.options.scale})`; // Get document offset.
                ...
                // Restore position
                elementStyle[cssPropTransform] = "translate(".concat(curPosition.left + offset.left, "px, ").concat(curPosition.top + offset.top, "px)").concat(` scale(${props.options.scale})`); // Restore size
...
// [SVG]
            ...
            function _setOptions(props, newOptions, isScalable = false) {
                ...
                ['onDrag', 'onMove', 'onDragStart', 'onMoveStart', 'onDragEnd', 'after'].forEach(function (option) {
            ...
            var PlainDraggable = /*#__PURE__*/function () {
                ...
                _createClass(PlainDraggable, [{
                    ...
                    key: 'after',
                    get: function get() {
                        return insProps[this._id].options.after;
                    },
                    set: function set(value) {
                        _setOptions(insProps[this._id], {after: value})
                    }
                }, {
                    key: 'scale',
                    get: function get() {
                        return insProps[this._id].options.scale;
                    },
                    set: function set(value) {
                        _setOptions(insProps[this._id], {scale: value}, true)
                    }
                }, {
                    key: "zIndex",
                    get: function get() {
                    ...
                    function initAll(eventType) {
                        ...
                        Object.keys(insProps).forEach(function (id) {
                            if (!initDoneItems[id]) {
                                ...
                                if (insProps[id].options.after !== undefined) {
                                    insProps[id].options.after(insProps[id]);
                                }
                            }
                        });
                        initDoneItems = {};
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (PlainDraggable);
