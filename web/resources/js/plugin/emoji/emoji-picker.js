const EmojiPicker = function (options) {
    ...
    const functions = {
        ...
        render: (e, attr) => {
            ...
            console.log('this.insertInto', this.insertInto);
        ...
        insert: e => {
            ...
            this.options.trigger.forEach(function (trigger) {
                if (trigger.insertInto[0] === insertInto[0]) {
                    is_clear = trigger.clear;
                }
            });
            if (is_clear) {
                $(myField).html(myValue);
                if (!$(myField).hasClass('is-active')) {
                    $(myField).addClass('is-active');
                }
            } else {
