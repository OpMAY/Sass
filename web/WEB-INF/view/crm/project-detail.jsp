                ...
                case 'timeline':
                    apiGetProject(TEMP_HASH).then((result) => {
                        ...
                        slider_timeline.addEventListener('mousedown', (e) => {
                            ...
                            ganttStartY = e.pageY - slider_timeline.offsetTop;
                            ganttScrollLeft = slider_timeline.scrollLeft;
                            ganttScrollTop = slider_timeline.scrollTop;
                        });
                        ...
                        slider_timeline.addEventListener('mousemove', (e) => {
                            ...
                            const y = e.pageY - slider_timeline.offsetTop;
                            const x_walk = (x - ganttStartX) * 1; //scroll-fast
                            const y_walk = (y - ganttStartY) * 1;
                            if (!isCtrlDown) {
                                slider_timeline.scrollLeft = ganttScrollLeft - x_walk;
                            }
                            slider_timeline.scrollTop = ganttScrollTop - y_walk;
                        });
                    });
                    break;
                case 'file':
