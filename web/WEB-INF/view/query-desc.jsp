            ...
            <div class="_inner">
              <div class="media plugin-title pt-24 pb-24">
                ...
                <div class="media-body _desc">
                  <h5 class="bold-h1 mb-24">QueryPlug - 데이터베이스 ERD 및 SQL 자동 생성</h5>
                  <div class="_usage mr-16">
                    <div class="icon-text medium-h5">
                      ...
                      <span class="c-gray-medium">12,017</span>
                    </div>
                  </div>
                </div>
                <div class="_install">
                ...
                <div class="_date medium-h5 c-gray-medium">일년 전 업데이트</div>
              </div>
              <div class="media plugin-hashtag mb-24">
                <button class="btn btn-medium btn-outline-gray-high-light">데이터 베이스</button>
                <button class="btn btn-medium btn-outline-gray-high-light">데이터</button>
                <button class="btn btn-medium btn-outline-gray-high-light">데이터룰</button>
                <button class="btn btn-medium btn-outline-gray-high-light">테이블 셋</button>
                <button class="btn btn-medium btn-outline-gray-high-light">AWS</button>
              ...
              <div class="plugin-subtitle">
                ...
                <ul class="_order mb-40">
                  <li class="regular-h5">
                    팀이 서비스를 개발하기 위해 기획, 관리, 데이터베이스 등등의 서비스 플러그인을 제공합니다.
                  </li>
                  <li class="regular-h5">
                    서비스를 개발하기 위해 기획, 관리, 데이터베이스 등등의 서비스 플러그인을 제공합니다.
                  </li>
                  <li class="regular-h5">
                    인을 제공합니다.
                  </li>
                </ul>
                <ul class="_order mb-48">
                  <li class="regular-h5">
                    팀이 서비스를 개발하기 위해 기획, 관리, 데이터베이스 등등의 서비스 플러그인을 제공합니다.
                  </li>
                  <li class="regular-h5">
              ...
              <div class="plugin-content">
                ...
                <div class="plugin-img-main mb-100">
                  <img src="../../resources/assets/images/sample/detail-content-sample-1.png">
                </div>
                <div class="plugin-img-main mb-100">
                  <img src="../../resources/assets/images/sample/detail-content-sample-2.png">
                </div>
              </div>
            </div>
          </div>
